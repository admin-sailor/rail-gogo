...
async function makePrediction() {
    ...
    if (homeTeamId === awayTeamId) {
        showToast('Both teams must be different', 'error');
        return;
    }
